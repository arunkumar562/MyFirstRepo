		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#infyakmproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"infyakmproject1-display": {
								"semanticObject": "infyakmproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=infy.akm.project1",
									"url": sap.ui.require.toUrl("infy/akm/project1")
								}
							}
						}
					}
